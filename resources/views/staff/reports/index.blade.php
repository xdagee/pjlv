...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <h3 class="title"><i class="material-icons">assessment</i> Organization Leave Reports</h3>
            <p class="text-muted">Comprehensive leave statistics across all staff members and departments.</p>
        </div>
    </div>
