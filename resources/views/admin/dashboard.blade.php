...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Total Staff</p>
                    <h3 class="title">{{ $totalStaff }}</h3>
                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Staff On Leave</p>
                    <h3 class="title">{{ $staffOnLeave }}</h3>
                </div>
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons">date_range</i> Currently
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    ...
                    <h3 class="title">{{ $pendingLeaves }}</h3>
                </div>
                <div class="card-footer">
                    <div class="stats">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <form method="GET" action="{{ url('/admin/dashboard') }}" class="form-inline">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Leave Requests</p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons">info</i> This period
                    </div>
                </div>
            </div>
        </div>
