            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="toolbar" style="margin-bottom: 20px;">
                        <a href="{{ url('admin/jobs/create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @forelse($jobs as $job)
                                    <tr>
                                        ...
                                        <!-- <td>{{ $job->is_multiple_staff ? 'Yes' : 'No' }}</td> -->
                                        <td class="td-actions text-right">
                                            <a href="{{ url('admin/jobs/' . $job->id) }}" class="btn btn-info btn-simple btn-xs"
                                                title="View">
